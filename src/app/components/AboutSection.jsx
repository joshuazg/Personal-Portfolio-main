...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Bachelor Degree in Software Enginnering</li>
        <li>Tunku Abdul Rahman University Management Technology, Malaysia</li>
      </ul>
    ),
  },
  {
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            ...
            experience working with JavaScript, React, Node.js, MySQL, PHP, 
            Flutter, Python, HTML, CSS, and Git. I am a quick learner and 
